...
// Event listener for any errors after the initial connection
db.on("error", (err) => {
...
app.get('/products01/:productId', (req, res) => {
...
app.put('/products01/:productId', (req, res) => {
  const id = req.params.productId;
...
app.delete('/products01/:productId', (req, res) => {
  const id = req.params.productId;
